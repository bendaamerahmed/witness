...
Six ways a green check lies. Recognize them in your own diff before someone else does:
...
(Yes, this file also applies to agents working on the witness repo itself. Especially to them.)
